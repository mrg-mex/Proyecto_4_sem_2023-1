...
En este readme va:
	...
	InstalaciÃ³n del sistema operativo
		Donde se encoentrÃ³ la imagen
		CÃ³mo se obtuvo la imagen
		Pasos a seguir para instalaciÃ³n
	Control de motores
		InstalaciÃ³n de Dynamixel Wizard 2.0
		Escaneo
		ID
		ConfiguraciÃ³n de Baudrate defalutl(1M) 57600 (tutoriales)
		Tabla de Memoria

		Repositorio de Dynamixel SDK
		Liga de github
		Liga a videos y tutoriales
		Â¿Por quÃ© no funcionÃ³?
